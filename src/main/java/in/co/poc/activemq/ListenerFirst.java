...
public class ListenerFirst {
  ...
  @JmsListener(destination = "queue_1", containerFactory = "jmsListenerContainerFactory")
  public void receiveMessage(Message<String> jsonMessage) throws JMSException {
    System.out.println("ListenerFirst Received message " + jsonMessage.getPayload() + " at "
